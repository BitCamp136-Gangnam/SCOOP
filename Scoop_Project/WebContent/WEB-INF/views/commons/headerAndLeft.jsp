                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="./layout-one-column.jsp">One Column</a></li>
                            <li><a href="./layout-two-column.jsp">Two column</a></li>
                            <li><a href="./layout-compact-nav.jsp">Compact Nav</a></li>
                            <li><a href="./layout-vertical.jsp">Vertical</a></li>
                            <li><a href="./layout-horizontal.jsp">Horizontal</a></li>
                            <li><a href="./layout-boxed.jsp">Boxed</a></li>
                            <li><a href="./layout-wide.jsp">Wide</a></li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="./app-calender.jsp">Calender</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    ...
                    <li>
                        <a href="widgets.jsp" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./table-basic.jsp" aria-expanded="false">Basic Table</a></li>
                            <li><a href="./table-datatable.jsp" aria-expanded="false">Data Table</a></li>
                        </ul>
                    </li>
