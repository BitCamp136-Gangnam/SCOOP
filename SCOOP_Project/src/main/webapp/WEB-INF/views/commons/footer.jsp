<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
      ...
      .panel {
        ...
        <div class="card_chat card">
                  ...
                  <div class="card-footer">
                     <div class="input-group">
                        ...
                        <textarea name="" class="form-control type_msg" style="color: #fff" placeholder="Type your message..."></textarea>
                        <div class="input-group-append">
        ...
        <img src="<c:url value="/resources/images/chat/chatopen.png" />" id="chatopen" name="on" width=50px height=auto style="cursor: pointer;">
        <img src="<c:url value="/resources/images/chat/questionmark.png" />" id="helpopen" name="on" width=50px height=auto style="cursor: pointer;">
        <img src="<c:url value="/resources/images/chat/close.png" />" id="closeopen" name="on" width=20px height=auto style="cursor: pointer; display: none">
        <!--**********************************
            Footer end
        ***********************************-->