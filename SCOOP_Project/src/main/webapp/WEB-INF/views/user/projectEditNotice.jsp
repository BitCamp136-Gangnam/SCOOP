			...
			<div class="content-body" style="height: 680px;">
				<div class="container-fluid row"
					...
					<div class="card"
						...
						<div class="row" style="margin: 15% 2% 3% 2%;">
							<input class="form-control createmodal" type="text" id="pntitle"name="pntitle"style="width: 75%; margin-left: 15%; border-radius: 0.5rem;"value="${edit.pntitle}">
						</div>
						<div class="myissueDetail" style="margin: 0 2% 3% 2%;">
							<textarea class="form-control createmodal" rows="10"
								...
								style="width: 75%; margin-left: 15%; border-radius: 0.5rem;">${edit.pncontent}</textarea>
						</div>
